<?php  qode_startit_get_module_template_part('templates/lists/parts/filter', 'blog'); ?>
<div class="qodef-blog-holder qodef-blog-type-masonry qodef-masonry-pagination-<?php echo qode_startit_options()->getOptionValue('masonry_pagination'); ?>">
...
<?php
	if(qode_startit_options()->getOptionValue('pagination') == 'yes') {
		...
		$pagination_type = qode_startit_options()->getOptionValue('masonry_pagination');
