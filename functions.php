...
if(!function_exists('qode_startit_styles')) {
    ...
    function qode_startit_styles() {
        ...
        /*temporarly set unminified files*/
//        wp_enqueue_style('qode_startit_modules_plugins', QODE_ASSETS_ROOT.'/css/plugins.min.css');
        wp_enqueue_style('qode_startit_modules_plugins', QODE_ASSETS_ROOT.'/css/plugins.css');
        //wp_enqueue_style('qode_startit_modules', QODE_ASSETS_ROOT.'/css/modules.min.css');
        wp_enqueue_style('qode_startit_modules', QODE_ASSETS_ROOT.'/css/modules.css');
...
if(!function_exists('qode_startit_scripts')) {
    ...
    function qode_startit_scripts() {
       ...
       /*jquery input mask*/
//        wp_enqueue_script('inputmask', QODE_ASSETS_ROOT.'/js/inputmask.js', array('jquery', 'inputmask'), false, true);
//        wp_enqueue_script('jquery.inputmask', QODE_ASSETS_ROOT.'/js/jquery.inputmask.js', array('jquery', 'inputmask'), false, true);
        wp_enqueue_script('slick', QODE_ASSETS_ROOT.'/js/slick.min.js', array('jquery'), false, true);
        wp_enqueue_style('slick', QODE_ASSETS_ROOT.'/css/slick.css');
        wp_enqueue_style('slick-theme', QODE_ASSETS_ROOT.'/css/slick-theme.css');
        ...
        wp_enqueue_script('qode_startit_modules', QODE_ASSETS_ROOT.'/js/modules.js', array('jquery'), false, true);
...
function custom_post_type() {
	...
	$labels = array(
		'name'                  => _x( 'Vacancy', 'Post Type General Name', 'text_domain' ),
	...
	$args = array(
		...
		'description'           => __( 'Vacancies', 'text_domain' ),
		'labels'                => $labels,
...
/*hide admin-bar for all, excepts administrators*/
/*
 ...
 * for subscribers.
 */
//function ins_disable_admin_bar() {
//    if ( ! current_user_can('edit_posts') ) {
//        add_filter('show_admin_bar', '__return_false');
//    }
//}
//add_action( 'after_setup_theme', 'isn_disable_admin_bar' );
 ...
 */
function ins_redirect_admin(){
    if ( ! defined('DOING_AJAX') && ! current_user_can('edit_posts') ) {
        wp_redirect( site_url() );
        exit;      
    }
}
add_action( 'admin_init', 'ins_redirect_admin' );

function hide_empty_email_error( $arg ) {
    if ( !empty( $arg->errors['empty_email'] ) ) unset( $arg->errors['empty_email'] );
}
add_action( 'user_profile_update_errors', 'hide_empty_email_error' );

/*if (strpos(home_url(), 'oft-im.com'))*/ define('WP_PRODUCTION', true);
//if (strpos(home_url(), 'mile.review')) define('WP_PRODUCTION', true);