    ...
    function qodefInitBackToTop(){       
        ...
        backToTopButton.on('click',function(e){
            e.preventDefault();
                    ...
                    qodef.html.animate({scrollTop: 0}, 500, 'linear');
        });
    }
        ...
        if (qodef.body.hasClass('qodef-smooth-page-transitions')) {
            ...
            $('a').click(function(e) {
                ...
                if (
                    ...
                    e.preventDefault();
                    /*findme whitescreen fix*/
                    /*$('.qodef-wrapper-inner').fadeOut(1000, function() { findme smoothscroll*/
    ...
    function qodefInitCarousels() {
        ...
        if (carouselHolders.length) {
            carouselHolders.each(function(){
                carousel = carouselHolders.children('.qodef-carousel');
...
(function($) {
   ...
   window.onunload = function(){$('.qodef-wrapper-inner').fadeIn(0);};
...
//function onPopState(){
//   console.log('popstate');
//   jQuery('.qodef-wrapper-inner').fadeIn(0);
//}
//
//
...
(function($) {
    ...
    $(document).ready(function(){
        ...
        $('a.fancybox[href=#table__modal]').on('click', function(){
            var text = $(this).find('span').text();
            $('#table__modal > p').text(text);
        });
        
        $('a.table__btn[href=#ppc_form_pop], a.table__btn[href=#smm_form_pop], a.table__btn[href=#seo_form_pop]').on('click', function(){
            var pack = $(this).closest( ".table__item" ).find('.table__header').text();
        ...
        if ( $( ".column-carousel-text" ).length ) {
            $('.column-carousel-text > .vc_column-inner > .wpb_wrapper').slick({
            dots: true,
            infinite: true,
            speed: 300,
            slidesToShow: 1,
        ...
        if ( $( ".carousel-text" ).length ) {
         ...
         /*gtm target tracking start*/
            $('a[href=#ppc_form_pop]').on( 'click', function(){
                dataLayer.push({'event': 'form_pop', 'category': 'open'});
            });
            $('a[href^="tel:"]').on( 'click', function(){
                dataLayer.push({'event': 'tel_number', 'category': 'click'});
            });


            $('a[href^="mailto:"]').on( 'click', function(){
                dataLayer.push({'event': 'action', 'action': 'emailClick'});
            });
         /*gtm target tracking end*/
